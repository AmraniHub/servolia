...
const COPY = {
  en: {
    ...
    progress: (a: number, b: number) => `Step ${a} of ${b} · Your answers are saved as you go`,
      ...
      body: "Your intake has been received. Your first draft is being built right now — a link to it lands in your inbox, usually within",
      bodyStrong: "a few minutes",
      bodyEnd: "— check your spam folder if it isn't there.",
      timeline: [
  ...
  fr: {
    ...
    progress: (a: number, b: number) => `Étape ${a} sur ${b} · Vos réponses sont enregistrées au fur et à mesure`,
      ...
      body: "Votre brief est bien reçu. Votre première version est en cours de création — un lien pour la voir arrive dans votre boîte mail, généralement sous",
      bodyStrong: "quelques minutes",
      bodyEnd: "— vérifiez vos spams si vous ne le voyez pas.",
      timeline: [
