...
export const T = {
  en: {
    ...
    upStarterH: "Add the 24/7 AI receptionist", upStarterB: "Your site captures forms — the Booking System answers every visitor in seconds, qualifies them and books the appointment, even at 2am.", upStarterCta: "Ask about upgrading",
    upStarterPrefill: "Hi! I'd like to upgrade to the Booking System (AI receptionist + online booking). Can you tell me more?",
    upGrowthH: "Upgrade to the complete Client System", upGrowthB: "Everything you have now, plus the full dashboard: lead pipeline, notes & history, WhatsApp notifications and the monthly analytics report.", upGrowthCta: "Ask about upgrading",
    upGrowthPrefill: "Hi! I'd like to upgrade to the Client System (full dashboard + pipeline + monthly reports). Can you tell me more?",
    upCareH: "Keep it running with a Care plan", upCareB: "Hosting, domain, security, updates and your AI receptionist — one monthly plan, cancel anytime, one month free if paid yearly.", upCareCta: "See Care plans",
    upCarePrefill: "Hi! I'd like to know more about the Care plans (monthly hosting + AI + support).",
  ...
  fr: {
    ...
    upStarterH: "Ajoutez l'assistante IA 24 h/24", upStarterB: "Votre site capte les formulaires — le Système IA répond à chaque visiteur en quelques secondes, le qualifie et prend le rendez-vous, même à 2 h du matin.", upStarterCta: "Demander la mise à niveau",
    upStarterPrefill: "Bonjour ! Je souhaite passer au Système IA (assistante IA + réservation en ligne). Pouvez-vous m'en dire plus ?",
    upGrowthH: "Passez au Système Client complet", upGrowthB: "Tout ce que vous avez déjà, plus le tableau de bord complet : pipeline de leads, notes et historique, notifications WhatsApp et le rapport mensuel.", upGrowthCta: "Demander la mise à niveau",
    upGrowthPrefill: "Bonjour ! Je souhaite passer au Système Client (tableau de bord complet + pipeline + rapports mensuels). Pouvez-vous m'en dire plus ?",
    upCareH: "Gardez tout en marche avec un forfait Care", upCareB: "Hébergement, domaine, sécurité, mises à jour et votre assistante IA — un seul forfait mensuel, résiliable à tout moment, un mois offert en annuel.", upCareCta: "Voir les forfaits Care",
    upCarePrefill: "Bonjour ! J'aimerais en savoir plus sur les forfaits Care (hébergement mensuel + IA + support).",
