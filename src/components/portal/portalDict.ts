...
export const T = {
  en: {
    ...
    upNoPlanH: "Start your monthly plan", upNoPlanB: "Hosting, your domain, 1 pro email address, security and the 24/7 AI receptionist — one monthly fee, cancel anytime with 30 days notice. Pay yearly and two months are free.", upNoPlanCta: "See the plans",
    upNoPlanPrefill: "Hi! I'd like to start a monthly plan. Can you tell me which one fits my clinic?",
    upEssentielH: "Move up to Croissance", upEssentielB: "Everything you have now, with three times the AI conversations — room for 2–3 practitioners, so a busy month never needs a top-up.", upEssentielCta: "Ask about upgrading",
    upEssentielPrefill: "Hi! I'd like to move up to the Croissance plan (three times the conversations). Can you tell me more?",
    upCroissanceH: "Move up to Performance", upCroissanceB: "For a practice running ads: 800 AI conversations a month, your requests handled first, and a strategy call every quarter that we book with you.", upCroissanceCta: "Ask about upgrading",
  ...
  fr: {
    ...
    upNoPlanH: "Démarrez votre formule mensuelle", upNoPlanB: "Hébergement, votre domaine, 1 adresse email pro, sécurité et l'assistante IA 24 h/24 — un seul tarif mensuel, résiliable à tout moment avec 30 jours de préavis. En annuel, deux mois sont offerts.", upNoPlanCta: "Voir les formules",
    upNoPlanPrefill: "Bonjour ! Je souhaite démarrer une formule mensuelle. Laquelle correspond à mon cabinet ?",
    upEssentielH: "Passez à Croissance", upEssentielB: "Tout ce que vous avez déjà, avec trois fois plus de conversations IA — de quoi couvrir 2 à 3 praticiens, sans pack en plus les mois chargés.", upEssentielCta: "Demander la mise à niveau",
    upEssentielPrefill: "Bonjour ! Je souhaite passer à la formule Croissance (trois fois plus de conversations). Pouvez-vous m'en dire plus ?",
    upCroissanceH: "Passez à Performance", upCroissanceB: "Pour un cabinet qui fait de la publicité : 800 conversations IA par mois, vos demandes traitées en premier, et un point stratégique chaque trimestre, que nous planifions avec vous.", upCroissanceCta: "Demander la mise à niveau",
