...
export const T = {
  en: {
    ...
    upCroissanceH: "Move up to Performance", upCroissanceB: "For a practice running ads: 800 AI conversations a month, priority support and a quarterly strategy call.", upCroissanceCta: "Ask about upgrading",
  ...
  fr: {
    ...
    upCroissanceH: "Passez à Performance", upCroissanceB: "Pour un cabinet qui fait de la publicité : 800 conversations IA par mois, un support prioritaire et un point stratégique trimestriel.", upCroissanceCta: "Demander la mise à niveau",
