...
export const T = {
  en: {
    ...
    tabs: { overview: "Overview", leads: "My leads", traffic: "Visitors", reports: "Reports", messages: "Messages", files: "Files", account: "Account" },
    fl: {
      title: "Your files",
      subtitle: "Your own documents, kept here and reachable whenever you need them. Upload as many as you like.",
      drop: "Drop files here, or click to choose",
      maxFile: "Any file type, up to {n}MB each",
      used: "{used} of {quota} used",
      quotaFull: "Your storage is full — remove a file, or ask us to raise it.",
      uploadErr: "That didn't upload — try again.",
      empty: "Nothing here yet",
      emptyBody: "Contracts, logos, photos, price lists — anything you want in one place you can always reach. We put what we produce for you in here too.",
      fromYou: "added by you",
      fromUs: "from Servolia",
      download: "Download",
      delete: "Delete",
      confirmDelete: "Delete it",
      cancel: "Keep",
      footnote: "These are copies kept here for your convenience. Always keep your own original of anything important.",
    },
    tf: {
    ...
    // quick actions + upgrade (overview tool hub)
    quickTitle: "Quick actions", quickView: "View my site", quickCopy: "Copy site link", quickCopied: "Link copied ✓",
    quickShare: "Share on WhatsApp", quickShareMsg: (url: string) => `Discover our website — book directly online: ${url}`,
    quickSig: "Copy email signature", quickSigCopied: "Signature copied ✓",
    quickMsg: "Message us",
    upTitle: "Get more from your system",
    upNoPlanH: "Start your monthly plan", upNoPlanB: "Hosting, your domain, pro email, security and the 24/7 AI receptionist — one monthly fee, cancel anytime with 30 days notice. Pay yearly and two months are free.", upNoPlanCta: "See the plans",
    upNoPlanPrefill: "Hi! I'd like to start a monthly plan. Can you tell me which one fits my clinic?",
    upEssentielH: "Move up to Croissance", upEssentielB: "Everything you have now, plus three times the AI conversations, the lead pipeline, Google reviews automation, SMS reminders and a monthly report showing exactly what the system brought in.", upEssentielCta: "Ask about upgrading",
    upEssentielPrefill: "Hi! I'd like to move up to the Croissance plan (pipeline + reviews + monthly report). Can you tell me more?",
    upCroissanceH: "Move up to Performance", upCroissanceB: "For a busier practice: 800 AI conversations a month, multi-practitioner routing, closed-loop ads tracking, custom AI training and a quarterly strategy call.", upCroissanceCta: "Ask about upgrading",
    upCroissancePrefill: "Hi! I'd like to move up to the Performance plan (multi-practitioner + ads tracking + custom AI). Can you tell me more?",
  ...
  fr: {
    ...
    tabs: { overview: "Aperçu", leads: "Mes leads", traffic: "Visiteurs", reports: "Rapports", messages: "Messages", files: "Fichiers", account: "Compte" },
    fl: {
      title: "Vos fichiers",
      subtitle: "Vos documents, conservés ici et accessibles à tout moment. Déposez-en autant que vous voulez.",
      drop: "Déposez vos fichiers ici, ou cliquez pour les choisir",
      maxFile: "Tous les formats, jusqu'à {n} Mo par fichier",
      used: "{used} sur {quota} utilisés",
      quotaFull: "Votre espace est plein — supprimez un fichier, ou demandez-nous de l'augmenter.",
      uploadErr: "L'envoi n'a pas abouti — réessayez.",
      empty: "Rien pour l'instant",
      emptyBody: "Contrats, logos, photos, tarifs — tout ce que vous voulez garder au même endroit, toujours accessible. Nous y déposons aussi ce que nous produisons pour vous.",
      fromYou: "ajouté par vous",
      fromUs: "de Servolia",
      download: "Télécharger",
      delete: "Supprimer",
      confirmDelete: "Supprimer",
      cancel: "Annuler",
      footnote: "Ce sont des copies conservées ici pour votre confort. Gardez toujours votre propre original de tout document important.",
    },
    tf: {
    ...
    quickTitle: "Actions rapides", quickView: "Voir mon site", quickCopy: "Copier le lien du site", quickCopied: "Lien copié ✓",
    quickShare: "Partager sur WhatsApp", quickShareMsg: (url: string) => `Découvrez notre site — réservez directement en ligne : ${url}`,
    quickSig: "Copier la signature email", quickSigCopied: "Signature copiée ✓",
    quickMsg: "Nous écrire",
    upTitle: "Tirez plus de votre système",
    upNoPlanH: "Démarrez votre formule mensuelle", upNoPlanB: "Hébergement, votre domaine, email pro, sécurité et l'assistante IA 24 h/24 — un seul tarif mensuel, résiliable à tout moment avec 30 jours de préavis. En annuel, deux mois sont offerts.", upNoPlanCta: "Voir les formules",
    upNoPlanPrefill: "Bonjour ! Je souhaite démarrer une formule mensuelle. Laquelle correspond à mon cabinet ?",
    upEssentielH: "Passez à Croissance", upEssentielB: "Tout ce que vous avez déjà, plus trois fois plus de conversations IA, le pipeline de leads, l'automatisation des avis Google, les rappels SMS et un rapport mensuel qui montre exactement ce que le système a rapporté.", upEssentielCta: "Demander la mise à niveau",
    upEssentielPrefill: "Bonjour ! Je souhaite passer à la formule Croissance (pipeline + avis Google + rapport mensuel). Pouvez-vous m'en dire plus ?",
    upCroissanceH: "Passez à Performance", upCroissanceB: "Pour un cabinet plus chargé : 800 conversations IA par mois, routage multi-praticiens, suivi publicitaire en boucle fermée, IA sur mesure et un point stratégique trimestriel.", upCroissanceCta: "Demander la mise à niveau",
    upCroissancePrefill: "Bonjour ! Je souhaite passer à la formule Performance (multi-praticiens + suivi pubs + IA sur mesure). Pouvez-vous m'en dire plus ?",
