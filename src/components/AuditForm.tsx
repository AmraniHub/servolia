...
const DICT = {
  en: {
    ...
    faqs: [
      ...
      { q: "How long does it take?", a: "The form: under 2 minutes. The audit: on screen in about 20 seconds. A personal reply within one working day." },
  ...
  fr: {
    ...
    faqs: [
      ...
      { q: "Combien de temps ça prend ?", a: "Le formulaire : moins de 2 minutes. L'audit : à l'écran en 20 secondes environ. Une réponse personnelle sous un jour ouvré." },
