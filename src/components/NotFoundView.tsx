...
/* Rendered as a client component on purpose: the root not-found is carried in
   every page's data payload as the layout's 404 boundary, and as a server
   tree it put Servolia's footer text into a practice's own homepage at her
   own domain (C2, measured 2026-09-22). As a client component the payload
   holds only a reference to it. */
