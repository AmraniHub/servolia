...
export default function FrenchHome() {
  ...
  const faqs = [
    ...
    { q: "Comment se passe le paiement ?", a: `Des frais de mise en place uniques de ${SETUP_PLAN.totalEur} € pour démarrer — rien n'est dû le jour de la livraison. Votre abonnement mensuel (${PLANS.essentiel.monthlyEur} €, ${PLANS.croissance.monthlyEur} € ou ${PLANS.performance.monthlyEur} €) est prélevé automatiquement à partir de 7 jours après votre paiement, résiliable à tout moment avec 30 jours de préavis. En annuel, la mise en place est offerte et vous avez deux mois gratuits.` },
