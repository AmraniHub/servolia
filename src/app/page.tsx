...
export default function HomePage() {
  ...
  const faqs = [
    ...
    { q: "How does the payment work?", a: `A one-time €${SETUP_PLAN.totalEur} installation to start — nothing is owed on delivery day. Your monthly plan (€${PLANS.essentiel.monthlyEur}, €${PLANS.croissance.monthlyEur} or €${PLANS.performance.monthlyEur}) is charged automatically from 7 days after you pay and cancels anytime with 30 days notice. Pay a year up front and the installation is waived plus two months are free.` },
