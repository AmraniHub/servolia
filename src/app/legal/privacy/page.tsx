        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 prose prose-slate max-w-none">
          <div className="space-y-8 text-[#374151] text-sm leading-relaxed">
            <div>
              ...
              <p>Servolia ("we", "us", "our") is an AI web systems studio providing websites, AI receptionists, lead systems, and business automation for service businesses in Europe and the US. Contact: <a href="mailto:hello@servolia.com" className="text-[#4F7EF7]">hello@servolia.com</a></p>
            </div>
            <div>
            ...
            <div>
              ...
              <p>We use Stripe for payment processing (subject to <a href="https://stripe.com/privacy" className="text-[#4F7EF7]">Stripe's privacy policy</a>) and Google Analytics (subject to Google's privacy policy). Stripe does not store your full card details on our servers.</p>
            </div>
            <div>
              <h2 className="text-lg font-black text-[#080E1C] mb-3">8. Your rights (GDPR)</h2>
              <p>You have the right to: access your data, correct inaccuracies, request deletion, restrict processing, data portability, and to withdraw consent at any time. Contact us at <a href="mailto:hello@servolia.com" className="text-[#4F7EF7]">hello@servolia.com</a> to exercise any of these rights.</p>
            </div>
            <div>
              <h2 className="text-lg font-black text-[#080E1C] mb-3">9. Contact</h2>
              <p>For any privacy-related questions or to exercise your rights: <a href="mailto:hello@servolia.com" className="text-[#4F7EF7]">hello@servolia.com</a></p>
            </div>
          </div>
        </div>
      </section>
