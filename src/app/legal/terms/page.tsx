      ...
      <section className="py-14 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="space-y-8 text-[#3F3F46] text-sm leading-relaxed">
            <div>
              <h2 className="text-lg font-black text-[#18181B] mb-3">1. Acceptance of these terms</h2>
            ...
            <div>
              <h2 className="text-lg font-black text-[#18181B] mb-3">2. Use of the Site</h2>
            ...
            <div>
              <h2 className="text-lg font-black text-[#18181B] mb-3">3. Services and purchases</h2>
            ...
            <div>
              <h2 className="text-lg font-black text-[#18181B] mb-3">4. Intellectual property</h2>
            ...
            <div>
              <h2 className="text-lg font-black text-[#18181B] mb-3">5. No guarantee of results</h2>
            ...
            <div>
              <h2 className="text-lg font-black text-[#18181B] mb-3">6. Third-party links and tools</h2>
            ...
            <div>
              <h2 className="text-lg font-black text-[#18181B] mb-3">7. Limitation of liability</h2>
            ...
            <div>
              <h2 className="text-lg font-black text-[#18181B] mb-3">8. Changes to these terms</h2>
