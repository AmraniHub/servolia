        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="space-y-8 text-[#3F3F46] text-sm leading-relaxed">
            ...
            <div>
              ...
              <p className="mb-3"><strong>What you own.</strong> Your content is yours: your business name, logo, branding, photographs, copy you supply, your service and price information, your client and enquiry records, and the text written specifically for your site. Your data is yours at all times and is exported to you on request (see 7 ter). Your domain name is yours too: one you already own stays in your name, and one Servolia registers is held for you and transferred into your name on request (see 7 bis).</p>
            ...
            <div>
              ...
              <p>Where Servolia registers a domain name as part of the service, <strong>Servolia registers it in its own name, on the client&apos;s behalf</strong>, with WHOIS privacy, and manages its DNS. Servolia holds that domain for the client and for no other purpose: it is never conditional on the plan continuing, and on request Servolia transfers it into the client&apos;s name, at no charge, to any registrar the client names (see below).</p>
