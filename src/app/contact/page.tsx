    ...
    <main className="flex flex-col bg-white">
      ...
      <section className="bg-[#FAFAF7] pt-28 pb-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-sm font-bold text-[#36671E] uppercase tracking-widest mb-3">Get Started</p>
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-24">
                ...
                <div className="mt-4 p-4 rounded-xl border border-[#36671E]/20 bg-[#EEF5EA]/40">
                  <p className="text-sm font-bold text-[#36671E] mb-1">Prefer email?</p>
            ...
            <div className="lg:col-span-2">
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="bg-white rounded-2xl border border-[#E8E6E0] p-8 shadow-sm">
                  ...
                  {/* Honeypot — invisible to real visitors, bait for bots that fill every field */}
                  ...
                  <p className="text-center text-xs text-[#52525B] mt-3">
                    By submitting you agree to our <a href="/legal/privacy" className="underline hover:text-[#36671E]">privacy policy</a>. No spam. Unsubscribe anytime.
                  </p>
                </form>
              )}
            </div>
