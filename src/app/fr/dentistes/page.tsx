      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            ...
            <h2 className="text-3xl font-black text-[#18181B]">Tout ce dont votre cabinet a besoin</h2>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {[
              ...
              { icon: <BarChart3 className="w-5 h-5" />, title: "Suivi des demandes", desc: "Google Analytics 4. Vous savez exactement d'où vient chaque patient.", color: "from-[#F59E0B] to-[#D97706]" },
            ].map((item, i) => (
