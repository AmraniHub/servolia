...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const countryRoutes = COUNTRY_SLUGS.map((slug) => ({
    url: `${base}/fr/pays/${slug}`, lastModified: now, changeFrequency: "monthly" as const, priority: 0.8,
  }));
  ...
  return [
    ...
    { url: `${base}/fr/essai`,                     lastModified: now, changeFrequency: "monthly", priority: 0.9 },
    ...
    { url: `${base}/fr/cas-clients`,               lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${base}/fr/a-propos`,                  lastModified: now, changeFrequency: "monthly", priority: 0.7 },
    { url: `${base}/fr/contact`,                   lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    ...
    { url: `${base}/fr/villes`,                    lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    ...solutionRoutes,
    ...industryRoutes,
    ...countryRoutes,
    ...frGeoRoutes,
