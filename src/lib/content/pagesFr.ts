...
const solutionsFr: MarketingContentFr[] = [
  {
    ...
    faqs: [
      ...
      { q: "En combien de temps est-il en ligne ?", a: "La plupart des sites IA sont en ligne en 3 à 5 jours ouvrés à partir du moment où votre formulaire d'intake et votre acompte sont reçus." },
      { q: "Suis-je propriétaire du site ?", a: "Totalement. Tous les fichiers et le code vous sont transférés au paiement final — aucun verrouillage, aucun hébergement otage." },
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "Est-elle incluse dans les formules ?", a: "Oui — la réceptionniste IA est incluse dans le Système IA et la formule Pro complète." },
    ],
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "Délai de mise en place ?", a: "Le système de réservation est généralement en ligne en 4 à 5 jours ouvrés dans le cadre du Système IA." },
    ],
  ...
  },
  {
    ...
    faqs: [
      { q: "Le CRM est-il inclus dans une formule ?", a: "Oui — le tableau de bord complet, le pipeline et le reporting font partie de la formule Pro." },
