...
export const INTEGRATIONS: Integration[] = [
  ...
  { label: "Google Places API (prospect import)", envVars: ["GOOGLE_PLACES_API_KEY"], category: "Growth & ads", required: false, note: "powers the Google Maps button on /admin/prospects — ~$0.017 per search. Enable 'Places API (New)' in Google Cloud Console" },
